...
3. CSV File Creation:
   - The Python script creates a CSV file named "processed_documents.csv".
...
4. CSV File Population:
   - The Python script automatically populates the CSV file with the extracted information from the documents.
